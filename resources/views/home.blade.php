...
<head>
    ...
    <title>Unpeep &#8211; Just Re:imagine Creativity</title>
    ...
    <style id='surge-woocommerce-style-inline-css' type='text/css'>
        @font-face {
            font-family: "star";
            src: url("{{ URL::asset('assets/wp-content/plugins/woocommerce/assets/fonts/star.eot') }}");
            src: url("{{ URL::asset('assets/wp-content/plugins/woocommerce/assets/fonts/stard41d.eot') }}") format("embedded-opentype"),
            url("{{ URL::asset('assets/wp-content/plugins/woocommerce/assets/fonts/star.woff') }}") format("woff"),
            url("{{ URL::asset('assets/wp-content/plugins/woocommerce/assets/fonts/star.ttf') }}") format("truetype"),
            url("{{ URL::asset('assets/wp-content/plugins/woocommerce/assets/fonts/star.svg') }}") format("svg");
            font-weight: normal;
            font-style: normal;
        }
    </style>
    ...
    <link rel="alternate" type="application/json+oembed" href="index.php/wp-json/oembed/1.0/embedde9d.json?url=https%3A%2F%2Fapp.ergo7.net%2Fsurge%2F" />
    <link rel="alternate" type="text/xml+oembed" href="index.php/wp-json/oembed/1.0/embed99d1?url=https%3A%2F%2Fapp.ergo7.net%2Fsurge%2F&amp;format=xml" />
    <noscript><style>.woocommerce-product-gallery{ opacity: 1 !important; }</style></noscript>
    <meta name="generator" content="Powered by WPBakery Page Builder - drag and drop page builder for WordPress." />
    <!--[if lte IE 9]><link rel="stylesheet" type="text/css" href="https://app.ergo7.net/surge/wp-content/plugins/js_composer/assets/css/vc_lte_ie9.min.css" media="screen"><![endif]-->
...
<div id="page" class="site">
        ...
        <div class="classic-menu container home-menu  ">
            ...
            <div class="menu-wrapper">
                <div class="col-md-1 col-sm-1 hidden-xs">
                    <div class="mini-cart">
                        <div class="cart-button" title="View your shopping cart"><a href="index.php/cart/index.html"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="mini-cart-icon" data-count="0"></span></a></div>
                    </div>
                </div>
                <nav id="normal-menu">
                    <div>
                        <div class="primary-menu">
                            <ul id="primary-menu" class="menu">
                                <li id="menu-item-3828" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-3828"><a href="#">HOME</a>

                                </li>
                                <li id="menu-item-3827" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3827"><a href="index.php/artist/index.html">ABOUT</a>

                                </li>
                                <li id="menu-item-3867" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3867"><a href="index.php/home-one-page/index.html">UNPEEP STOCK</a></li>
                                <li id="menu-item-3867" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3867"><a href="index.php/music-album/index.html">BOOK NOW</a></li>
                                <li id="menu-item-3868" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3868"><a href="index.php/contact/index.html">CONTACT</a></li>
                                <li id="menu-item-3875" class="menu-item menu-item-type-post_type menu-item-object-post menu-item-3875"><a href="index.php/2018/05/16/the-perfect-music-fest/index.html">BLOG</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
    ...
    <div id="content" class="site-content">
        ...
        <div id="music-wrapper" class="page-player-style-2 active">
    ...
    <footer id="colophon" class="site-footer footer">
        ...
        <div class="container">
            <div class="glitch-container">
                <h2 class="glitch footer-banner-text" data-text="UNPEEP">UNPEEP</h2>
            </div>
            <div class="row">
                <div class="col-md-4">
                    ...
                    <aside class="sidebar footer-sidebar" itemscope="itemscope" itemtype="http://schema.org/WPSideBar">
                        <aside id="text-2" class="widget widget_text">
                            <div class="textwidget">
                                ...
                                <div style="text-align: center;color:#ffffff">+234 705 431 6907</div>
                            </div>
                        </aside>
                    </aside>
                </div>
        ...
        <div class="copyright">
            <div class="container">
                ...
                <div class="site-info">
                    Made with <i class="fa fa-heart"></i> For <a target="_blank" href="#">Creators</a> </div>
                <!-- .site-info -->
            </div>
        </div>
    </footer>
...
<link rel='stylesheet' id='vc_tta_style-css' href='{{ URL::asset('assets/wp-content/plugins/js_composer/assets/css/js_composer_tta.min4245.css') }}' type='text/css' media='all' />
<script type='text/javascript'>
    /* <![CDATA[ */
    var wpcf7 = {
        "apiSettings": {
...
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/contact-form-7/includes/js/scriptsaead.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/woocommerce/assets/js/jquery-blockui/jquery.blockUI.min44fd.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/woocommerce/assets/js/js-cookie/js.cookie.min6b25.js') }}'></script>
<script type='text/javascript'>
    /* <![CDATA[ */
...
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.min4c8b.js') }}'></script>
<script type='text/javascript'>
    /* <![CDATA[ */
...
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/woocommerce/assets/js/frontend/cart-fragments.min4c8b.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/skrollr.min.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/audio.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/p5.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/p5.dom.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/p5.sound.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/visualizer.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/parallax.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/jquery.lettering.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/jquery.textillate.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/particles.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/scrolloverflow.min.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/jquery.fullPage.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/bootstrap.min.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/wavesurfer.min.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/anime.min.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/themes/surge/assets/js/custom.js') }}'></script>
<script type='text/javascript'>
...
<script type='text/javascript' src='{{ URL::asset('assets/wp-includes/js/wp-embed.min55fe.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/kirki/modules/webfont-loader/vendor-typekit/webfontloader8e5e.js') }}'></script>
<script type='text/javascript'>
    WebFont.load({
        google: {
            families: ['Roboto::cyrillic,cyrillic-ext,devanagari,greek,greek-ext,khmer,latin,latin-ext,vietnamese,hebrew,arabic,bengali,gujarati,tamil,telugu,thai',
                'Montserrat::cyrillic,cyrillic-ext,devanagari,greek,greek-ext,khmer,latin,latin-ext,vietnamese,hebrew,arabic,bengali,gujarati,tamil,telugu,thai',
                'Oswald::cyrillic,cyrillic-ext,devanagari,greek,greek-ext,khmer,latin,latin-ext,vietnamese,hebrew,arabic,bengali,gujarati,tamil,telugu,thai'
            ]
        }
    });
    WebFont.load({
...
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/js_composer/assets/js/dist/js_composer_front.min4245.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/js_composer/assets/lib/bower/skrollr/dist/skrollr.min4245.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/js_composer/assets/lib/prettyphoto/js/jquery.prettyPhoto.min4245.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/js_composer/assets/lib/bower/masonry/dist/masonry.pkgd.min4245.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/js_composer/assets/lib/owl-carousel2-dist/owl.carousel.min4245.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/js_composer/assets/lib/bower/imagesloaded/imagesloaded.pkgd.min55fe.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-includes/js/underscore.min4511.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/js_composer/assets/lib/waypoints/waypoints.min4245.js') }}'></script>
<script type='text/javascript' src='{{ URL::asset('assets/wp-content/plugins/js_composer/assets/js/dist/vc_grid.min4245.js') }}'></script>
